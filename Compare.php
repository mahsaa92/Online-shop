...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Css/Css_Comp.css">
        <title></title>
    </head>
    <body>
        ...
        <div class="Menu">
           ...
           <?php 
          $Sql_Model = "SELECT `Id`, `Brnd_Id`, `Net`, `Camera`, `Soft`, `chpst`, `G_Spcfc`, `grnrt`, `Scrn`, `Memo`, `Clr`, `Sound`, `Status`, `Model`, `Price`, `Image` FROM `mobile` Where `Model`='".$_POST['Name_1']."'";
         // print($Sql_Model);
           $Result_Model=mysql_query($Sql_Model,$SqlConnection->Connction);
            ...
            <?php 
          $Sql_Model = "SELECT `Id`, `Brnd_Id`, `Net`, `Camera`, `Soft`, `chpst`, `G_Spcfc`, `grnrt`, `Scrn`, `Memo`, `Clr`, `Sound`, `Status`, `Model`, `Price`, `Image` FROM `mobile` Where `Model`='".$_POST['Name_2']."'";
         // print($Sql_Model);
           $Result_Model=mysql_query($Sql_Model,$SqlConnection->Connction);
               if(($Row_Model= mysql_fetch_object($Result_Model))==NULL)
               {
